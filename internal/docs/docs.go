...
Доступна только админу",
        ...
        "/admin/stats": {
            "get": {
                ...
                "description": "Метрики по всем торгам: лоты по статусам, суммарная выручка, 
средний чек, топ-категории",
                "produces": [
                    "application/json"
                ],
                "tags": [
...
Сумма ставки должна соответствовать минимальному шагу ставки.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
